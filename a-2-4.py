...
# alina_bill = bill * 1.12 (если процент стабилен)
# alina_total = alina_bill / people
# print(f"Each person should pay: $ {alina_total:.2f}")


# :.2f = 2 знака после точки в f-String
#  смысл калькулятора этого: счет * 1.чаевых (чай / 100 * счет) + счет и потом разделить на людей
# а не наоборот
